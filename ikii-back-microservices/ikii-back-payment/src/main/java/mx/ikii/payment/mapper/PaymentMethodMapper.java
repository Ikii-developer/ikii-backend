...
public class PaymentMethodMapper {
  ...
  public static PaymentMethodResponse paymentSourceToPaymentMethodResponse(
  ...
  public static List<PaymentMethodResponse> paymentSourceToPaymentMethodsResponse(
      List<PaymentSource> paymentsSource) {
