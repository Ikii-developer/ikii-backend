...
public class IkiiPaymentOrderControllerImpl implements IkiiPaymentOrderController {
	...
	@Override
	public ResponseEntity<OrderConektaResponse> getOrderConekta(@PathVariable String customerRequest) {
		
		return ResponseEntity.ok(ikiiPaymentServiceWrapper.findOrderConekta(customerRequest));
	}
